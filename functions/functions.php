...
function twitter_feed_git_init() {
	...
	if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
	    $config = array(
	        ...
	        'api_url' => 'https://api.github.com/repos/Jonathan-Garber/Wordpress-Twitter-Feed', // the github API url of your github repo
	        'raw_url' => 'https://raw.github.com/Jonathan-Garber/Wordpress-Twitter-Feed/master', // the github raw url of your github repo
	        'github_url' => 'https://github.com/Jonathan-Garber/Wordpress-Twitter-Feed', // the github url of your github repo
	        'zip_url' => 'https://github.com/Jonathan-Garber/Wordpress-Twitter-Feed/zipball/master', // the zip url of the github repo
